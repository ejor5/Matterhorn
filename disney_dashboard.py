...
class DisneyDashboard:
    def __init__(self, root):
        ...
        # Create custom fonts using installed Quicksand
        self.custom_font = ('Quicksand', 16, 'bold')
        self.ride_font = ('Quicksand', 16)
        self.time_font = ('Quicksand', 16)
        ...
        # Create rounded corner overlay frame - adjusted styling
        self.overlay_frame = tk.Frame(
            self.main_frame,
            bg='#1A1A1A',
            highlightbackground='#2A2A2A',
            highlightthickness=2,
            bd=8,  # Increased border for more rounded effect
            relief='ridge'
        )
        ...
        # Header with removed text shadow
        header = tk.Label(
            content_frame,
            text="Disneyland",
            font=('Quicksand', 20, 'bold'),
            bg='#1A1A1A',
            fg='#FFFFFF'  # Brighter white without shadow
        )
        ...
        # Rides container with transparency
        ...
        for ride_name, href in self.rides.items():
            # Using a slightly lighter color to simulate 85% opacity on black background
            ...
            # Create emoji label with fixed width
            tk.Label(card,
                    text=emoji,
                    font=self.ride_font,
                    bg='#1A1A1A',
    ...
    def get_time_color(self, wait_time):
        try:
            ...
            if minutes <= 25: return "#8dd577"
            elif minutes <= 70: return "#e8ea65"
            else: return "#c75252"
        except:
            return "#888888"
    ...
    def update_wait_times(self):
        ...
        # Update every 60 seconds instead of 300000
